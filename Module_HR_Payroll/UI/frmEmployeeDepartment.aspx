<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmEmployeeDepartment.aspx.cs" Inherits="pbERP.Module_HR_Payroll.UI.frmEmployeeDepartment" %>
            ...
            <div class="row">
                <div class="col-md-12" style="background-color: #fbfbd5">
                    <div class="alert alert-info" role="alert">
                        <h2 class="text-center inner_title"><i class="fa fa-user-plus"></i>Create Emloyee Department</h2>
                    </div>
                     <div>
                    ...
                    <fieldset class="crateViewWrap">
                        <div class="crateViewFieldBox">
                            <div class="editor-label">
                                <asp:Label Text="Employee Department ID: " runat="server" />
                            </div>
                            <div class="editor-field">
                                <asp:TextBox ID="txtDepartmentID" ReadOnly="true" runat="server" />
                            </div>
                        </div>
                        <div class="crateViewFieldBox">
                            <div class="editor-label">
