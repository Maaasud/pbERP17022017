<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmEmployeeDesignation.aspx.cs" Inherits="pbERP.Module_HR_Payroll.UI.frmEmployeeDesignation" %>
            ...
            <div class="row">
                <div class="col-md-12" style="background-color: #fbfbd5">
                    <div class="alert alert-info" role="alert">
                        <h2 class="text-center inner_title"><i class="fa fa-user-plus"></i>
                        Create Employee Designation</h2>
                    </div>
                     <div>
                    ...
                    <fieldset class="crateViewWrap">
                        <div class="crateViewFieldBox">
                            <div class="editor-label">
                                <asp:Label Text="DesignationId: " runat="server" />
                            </div>
                            <div class="editor-field">
                                <asp:TextBox ID="txtDesignationID" ReadOnly="true" runat="server" />
                            </div>
                        </div>
                        <div class="crateViewFieldBox">
                            <div class="editor-label">
                            ...
                            <div class="editor-field">
                                <asp:TextBox ID="txtDesignation" runat="server" >Input a Designation</asp:TextBox>
                            </div>
                        </div>

                        <div class="crateViewSubmitWrap">
                            <div class="backTo">
                                <asp:LinkButton Text="Back To list" runat="server" class="btn btn-primary" />
                            </div>
