<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmEmployeeDivision.aspx.cs" Inherits="pbERP.Module_HR_Payroll.UI.frmEmployeeDivision" %>
        ...
        <div class="row">
            <div class="col-md-12" style="background-color: #fbfbd5">
                <div class="alert alert-info" role="alert">
                    <h2 class="text-center"><i style="font-size:40px;" class="fa fa-user-plus"></i> Create Employee Division</h2>
                </div>
                    ...
                    <fieldset class="crateViewWrap">
                        <div class="crateViewFieldBox">
                            <div class="editor-label">
                                <asp:Label Text="Division ID: " runat="server" />
                            </div>
                        ...
                        <div class="crateViewFieldBox">
                            <div class="editor-label">
                                <asp:Label Text="Division Name: " runat="server" />
                            </div>
                            <div class="editor-field">
