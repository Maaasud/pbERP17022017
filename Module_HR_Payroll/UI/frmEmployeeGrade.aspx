<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmEmployeeGrade.aspx.cs" Inherits="pbERP.Module_HR_Payroll.UI.frmEmployeeGrade" %>
            ...
            <div class="row">
                <div class="col-md-12" style="background-color: #fbfbd5">
                    <div class="alert alert-info" role="alert">
                        <h2 class="text-center inner_title"><i class="fa fa-user-plus"></i>Create Employee Grade</h2>
                    </div>
                    ...
                    <fieldset class="crateViewWrap">
                        <div class="crateViewFieldBox">
                            <div class="editor-label">
                                <asp:Label Text="Employee Grade ID: " runat="server" />
                            </div>
                            <div class="editor-field">
                                <asp:TextBox ID="txtEmpGradeID" runat="server" />
                            </div>
                        </div>
                        <div class="crateViewFieldBox">
                            <div class="editor-label">
                                <asp:Label Text="Employee Grade: " runat="server" />
                            </div>
                            <div class="editor-field">
                                <asp:TextBox ID="txtEmpGrade" runat="server" />
                            </div>
                        </div>
