<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmEmployeeShift.aspx.cs" Inherits="pbERP.Module_HR_Payroll.UI.frmEmployeeShift" %>
            ...
            <div class="row">
                <div class="col-md-12" style="background-color: #fbfbd5">
                    <div class="alert alert-info" role="alert">
                        <h2 class="text-center inner_title"><i class="fa fa-user-plus"></i>Create City Name</h2>
                    </div>
                     <div>
                    ...
                    <fieldset class="crateViewWrap">
                        <div class="crateViewFieldBox">
                            <div class="editor-label">
                                <asp:Label Text="Employee Shift ID: " runat="server" />
                            </div>
                            <div class="editor-field">
                                <asp:TextBox ID="txtEmpShiftID" ReadOnly="true" runat="server" />
                            </div>
                        </div>
                        <div class="crateViewFieldBox">
                            <div class="editor-label">
                                <asp:Label Text="Employee Shift: " runat="server" />
                            </div>
                            <div class="editor-field">
                                <asp:TextBox ID="txtEmployeeShift" runat="server" />
                            </div>
                        </div>
                        <div class="crateViewFieldBox">
